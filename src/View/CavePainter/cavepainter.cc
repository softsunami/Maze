...
CavePainter::CavePainter(QWidget* parent) : QWidget(parent) {}

void CavePainter::SetCave(CaveType* cave) { cave_ = cave; }

inline bool CavePainter::IsAliveCell_(bool cell) { return cell; }

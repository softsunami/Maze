...
void MainWindow::EmitUploadMaze_() {
  QString file_path = QFileDialog::getOpenFileName(
      this, ("Select Maze"), "../mazes/", "Text Files (*.txt)");
...
void MainWindow::EmitSaveMaze_() {
  QString file_path = QFileDialog::getSaveFileName(
      this, "Save Maze", "../mazes/", "Text Files (*.txt)");
...
void MainWindow::EmitUploadCave_() {
  QString file_path = QFileDialog::getOpenFileName(this, "Select cave", "./",
                                                   "Cave files (*.txt)");
...
void MainWindow::CaveStartGeneration_() {
  if (timer_ == nullptr) {
    ui_->pushButtonStart->setStyleSheet(
        ui_->pushButtonStart->styleSheet().replace("background-color: #D9D9D9",
